...
class OfficerDetailWindow(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self.debt_chart = CustomerLineChart("Chất lượng tín dụng", value_kind="percent")
        ...
        self._add_chart_table_tab("Chất lượng tín dụng", self.debt_chart, self.debt_model, (95, 135, 135, 105, 105, 95, 95, 90, 90))
